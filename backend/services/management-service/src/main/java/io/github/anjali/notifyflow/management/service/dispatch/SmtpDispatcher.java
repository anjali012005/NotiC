...
public class SmtpDispatcher implements NotificationDispatcher {
    ...
    private static final Logger log = LoggerFactory.getLogger(SmtpDispatcher.class);

    @Override
    public void dispatch(NotificationProvider provider, String recipient, String subject, String body) {
        log.info("SMTP dispatch | provider={} | recipient={} | subject={} | body={}", provider, recipient, subject, body);
    }
}
