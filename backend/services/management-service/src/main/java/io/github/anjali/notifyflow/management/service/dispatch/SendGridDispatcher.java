...
public class SendGridDispatcher implements NotificationDispatcher {
    ...
    private static final Logger log = LoggerFactory.getLogger(SendGridDispatcher.class);

    @Override
    public void dispatch(NotificationProvider provider, String recipient, String subject, String body) {
        log.info("SENDGRID dispatch | provider={} | recipient={} | subject={} | body={}", provider, recipient, subject, body);
    }
}
